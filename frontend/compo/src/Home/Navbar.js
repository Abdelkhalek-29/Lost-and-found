      ...
      <div className="right">
        ...
        {userData && (
          <div className="user" onClick={toggleMenu}>
            <img src={userData ? userData.profileImage.url : loadingphoto} alt="Profile Pic" />
             ...
             <div className="status-indicator1"></div>
              ...
              <div className="menu">
                <div className='UserInfoMenu'>
                 <img src={userData ? userData.profileImage.url : loadingphoto} alt="Profile Pic" />
                 <div className="menu__titleProfile">{userData.name}</div>
                 <div className="menu__subtitleProfile">{userData.userName}</div>

                 </div>
                <ul>
                  <div className='btnViewC'>
                  <button className='btnView' onClick={() => navigate("/ProfilePage")}>View Profile</button>
                  </div>
                  <li>
