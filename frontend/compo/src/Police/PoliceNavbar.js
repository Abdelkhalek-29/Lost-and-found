...
import policephoto from './Egyptian_Police_Emblem.svg.png'; // Import the emblem
...
function PoliceNavbar() {
  ...
  return (
    <div className={`navbar ${darkMode ? 'dark' : ''}`}>
      <div className='left'>
        <Link to="/Police" style={{ textDecoration: 'none' }}>
          <h4>
            <span style={{ textTransform: 'uppercase', fontWeight: 700, marginLeft: '2px', color: 'black' }}>
              Find<span style={{ color: 'orange' }}>ME</span>
            </span>
          </h4>
        </Link>
        <Link to="/PoliceSearch" className="link-style">
      ...
      <div className="right">
        <div className="user" onClick={toggleMenu}>
          <img className="avatar11" src={policephoto} alt="Police Emblem" />
          <div className="status-indicator1"></div>
          {isMenuOpen && (
            <div className="menupolice">
              <div className='UserInfoMenu'>
                <img className="avatar11" src={policephoto} alt="Police Emblem" />
                <div className="menu__titleProfile">Police Stations</div>
              </div>
              <ul>
                ...
                <div className='BtnMode'>
                  ...
                  <button className='BtnLight' onClick={() => darkMode && toggleTheme()}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-sun fa-fw mode-switch" viewBox="0 0 16 16">
                      <path d="M8 11a3 3 0 1 1 0-6 3 3 0 0 1 0 6zm0 1a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM8 0a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 0zm0 13a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 13zm8-5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2a.5.5 0 0 1 .5.5zM3 8a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2A.5.5 0 0 1 3 8zm10.657-5.657a.5.5 0 0 0 0 .707l-1.414 1.415a.5.5 0 1 1-.707-.708l1.414-1.414a.5.5 0 0 0 .707 0zm-9.193 9.193a.5.5 0 0 0 0 .707L3.05 13.657a.5.5 0 0 1-.707-.707l1.414-1.414a.5.5 0 0 0 .707 0zm9.193 2.121a.5.5 0 0 1-.707 0l-1.414-1.414a.5.5 0 0 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .707zM4.464 4.465a.5.5 0 0 1-.707 0L2.343 3.05a.5.5 0 1 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .708z"></path>
                    </svg>
                  </button>
